...
public class contact extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu);
            AlertDialog.Builder c = new AlertDialog.Builder(contact.this);
            c.setTitle("Contact Us").setMessage("Email : divairmaa@yahoo.com\n" + "No : 082232433616\n" + "Line : divairmaa").setNeutralButton("OKE!", new DialogInterface.OnClickListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    ...
                    case R.id.navigation2:
                        Toast.makeText(getApplicationContext(),"Order Pesanan Telah Dipilih",Toast.LENGTH_SHORT).show();
                        Intent a =new Intent (contact.this,order.class);
                        startActivity(a);
                        return true;
                    ...
                    case R.id.navigation5:
                        Toast.makeText(getApplicationContext(), "Terimakasih atas kunjungannya", Toast.LENGTH_SHORT).show();
